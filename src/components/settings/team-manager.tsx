...
export function TeamManager() {
  ...
  }}><Input aria-label="שם צוות חדש" placeholder="שם צוות חדש" maxLength={100} value={name} onChange={(event) => setName(event.target.value)} /><Button disabled={busy || !name.trim()}>צור צוות</Button></form>;
}
